    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.inner}>
        ...
        <Text style={styles.body}>
          You will be signed out on this device. All synced data is safely stored in the cloud.
          Unsynced tickets will be lost.
        </Text>
        ...
        {hasPending && (
          <View style={styles.warningCard}>
            ...
            <Text style={styles.warningText}>
              You have {pendingCount} unsynced tickets. Sync before signing out to avoid data loss.
            </Text>
